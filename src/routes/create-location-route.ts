...
router.post(
  ...
  async (req: Request, res: Response) => {
    ...
    const createdLocation = Location.build({
      ...
      locationFirstName: location.locationFirstName,
      locationLastName: location.locationLastName,
      locationEmail: location.locationEmail,
    ...
    const createLocation: LocationResponse = {
      ...
      locationFirstName: savedLocation.locationFirstName,
      locationLastName: savedLocation.locationLastName,
